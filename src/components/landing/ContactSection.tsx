...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="px-4 pb-28 pt-14 md:px-6 md:pb-32 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="glass-panel rounded-[2rem] p-9 md:p-11">
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="space-y-7">
              ...
              <div className="rounded-[1.6rem] border border-cyan-400/14 bg-cyan-400/[0.04] p-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {contactCards.map((card) => {
                ...
                return (
                <div key={card.label} className="rounded-[1.6rem] border border-white/8 bg-slate-950/45 p-6">
