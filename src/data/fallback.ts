...
export const fallbackTeamMembers: TeamMember[] = [
  {
    ...
    bio: 'Guides the academic vision of MC Mathematics through lesson strategy, paper direction, and disciplined mathematics coaching.',
  },
  {
    id: 'team-2',
    name: 'Sihina Nildiya',
    role: 'Operations Coordinator',
    image_url: 'https://ui-avatars.com/api/?name=Sihina+Nildiya&background=0f172a&color=8b5cf6&size=400',
    bio: 'Keeps classes, coordination, and institute-side logistics running smoothly across students, schedules, and parent communication.',
  },
  {
    id: 'team-3',
    name: 'Oshan Rathmalgoda',
    role: 'Official Graphic Designer',
    image_url: 'https://ui-avatars.com/api/?name=Oshan+Rathmalgoda&background=1e293b&color=22d3ee&size=400',
    bio: 'Shapes the visual identity of MC Mathematics through branded graphics, promotional design, and polished creative assets.',
  },
  {
    id: 'team-4',
    name: 'Thenuja Premasiri',
    role: 'Social Media Supervisor',
    image_url: 'https://ui-avatars.com/api/?name=Thenuja+Premasiri&background=172554&color=bfdbfe&size=400',
    bio: 'Oversees digital presence, social communication, and content flow so MC Mathematics stays active and visible across platforms.',
  },
  {
    id: 'team-5',
    name: 'Dewmi',
    role: 'Paper Review Lead',
    image_url: 'https://ui-avatars.com/api/?name=Dewmi&background=312e81&color=e9d5ff&size=400',
    bio: 'Leads paper marking support, review flow, and answer-checking quality across the institute’s paper practice work.',
  },
  {
    id: 'team-6',
    name: 'Wethum',
    role: 'Student Experience Associate',
    image_url: 'https://ui-avatars.com/api/?name=Wethum&background=0f3b2e&color=bbf7d0&size=400',
    bio: 'Supports the student experience through class assistance, follow-ups, and day-to-day coordination around the learning environment.',
  },
]
